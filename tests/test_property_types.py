...
class TestPropertyTypeFeatures:
    ...
    def test_engineer_features_flat_creates_floor_features(self):
        ...
        assert result["Floor_Category"].iloc[0] in ["Low", "Mid", "High", "Ground", "Top"]
    ...
    def test_engineer_features_house_excludes_floor_features(self):
        ...
        assert result["Is_Ground_Floor"].iloc[0] == 0 or pd.isna(result["Is_Ground_Floor"].iloc[0])
        assert result["Is_Top_Floor"].iloc[0] == 0 or pd.isna(result["Is_Top_Floor"].iloc[0])
    ...
    def test_engineer_features_flat_specific_features_list(self):
        ...
        expected_features = [
            "Area", "Photo_Count", "Rooms_Numeric", "Current_Floor_Num", "Total_Floors_Num",
            "Floor_Ratio", "Area_per_Room", "Rooms_per_100sqm", "Area_Log", "Photo_Count_Log",
            "Is_Ground_Floor", "Is_Top_Floor", "Is_Agency", "Floor_Category"
        ]
